...
namespace ManualResetEventSlimDemo
{
    class Program
    {
        ...
        static void MRES_SetWaitReset()
        {
            ...
            ManualResetEventSlim mres3 = new ManualResetEventSlim(true); // initalize as singaled
            ...
            var observer = Task.Factory.StartNew(() =>
            {
                ...
                mres3.Reset(); // should witch to unsingaled
        ...
        static void MRES_SpinCountWaitHandle()
        {
            ...
            ManualResetEventSlim mres1 = new ManualResetEventSlim(false, 2000);
            ManualResetEventSlim mres2 = new ManualResetEventSlim(false, 2000);
